...
// npx hardhat run test/bigPrizePool/setTransferPercent.js --network ht-testnet

const contractName = "NullsBigPrizePool";
let contractAddr = "";

const rewardAddr = "0xB1877E668f3827FF8301EfEAe6aB7aB081d75f11";
const percent = 1;
...
async function main() {
  ...
  ret = await contract.setTransferPercent(rewardAddr, percent);
